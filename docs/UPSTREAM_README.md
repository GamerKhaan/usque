# Archived upstream README (v4.2.1)

The text below is the original upstream documentation, including its author voice and acknowledgements. Relative links refer to the upstream repository. For this fork use the [production README](../README.md).
